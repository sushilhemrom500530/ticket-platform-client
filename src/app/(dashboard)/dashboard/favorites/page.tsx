              ...
              <Card
                ...
                cover={
                  <div className="relative h-48 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 right-4 p-2 bg-white/90 backdrop-blur rounded-full">
                      <Heart
                        size={18}
              ...
              >
                ...
                <Link href={`/events/${event._id}`}>
                  <Button
                    type="primary"
                    block
                    className="rounded-xl h-10 bg-blue-600 flex items-center justify-center gap-2"
                  >
                    View Details
                    <ArrowRight size={16} />
                  </Button>
            ...
            description={
              <div className="text-gray-400">
                ...
                <Link href="/events">
                  <Button
                    type="primary"
                    className="mt-6 h-10 px-8 rounded-lg bg-blue-600"
                  >
                    Browse Events
                  </Button>
                </Link>
