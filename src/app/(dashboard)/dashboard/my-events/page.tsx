  ...
  return (
    <div className="p-6">
      ...
      {events.length > 0 ? (
                ...
                cover={
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <Tag
                        color="green"
                        className="rounded-lg border-none px-3 py-1 font-bold shadow-sm backdrop-blur-md bg-emerald-500/90 text-white"
                      >
                        UPCOMING
                      </Tag>
                    </div>
              ...
              >
                ...
                <Link href={`/events/${event?._id}`}>
                  <Button
                    type="primary"
                    block
                    className="rounded-xl h-11 bg-emerald-600 hover:bg-emerald-700 border-none flex items-center justify-center gap-2 font-bold transition-all"
                  >
                    View Tickets
                    <ArrowRight size={18} />
                  </Button>
        ...
        <Card className="bg-white rounded-2xl py-20">
          <Empty
            ...
            description={
              <div className="text-gray-400">
                ...
                <Link href="/events">
                  <Button
                    type="primary"
                    className="mt-6 h-10 px-8 rounded-lg bg-emerald-600 border-none font-bold"
                  >
                    Discover Events
                  </Button>
                </Link>
